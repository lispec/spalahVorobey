...
////  -------------- УСТАНОВКА КУКИ ------------------
//
//if (isset($_POST['data']) && ctype_alpha($_POST['data']['name'])) {  // валидация массива и поля имени
//    $note = $_POST['data'];             // извлекаем из суперглобального массива свой подмассив
//    $note['date'] = date("m.d.Y");      // добавляем в полученный массив дату
//    $date = fopen("guestbook.csv", "a");     // открываем файл
//    fwrite($date, json_encode($note) . "\n");    // * записываем элементы нашего массива в файл csv
//    fclose($date);                      // закрываем файл
//
//    setcookie("email", $_POST['data']['email']);    // * установка cookie
//}
